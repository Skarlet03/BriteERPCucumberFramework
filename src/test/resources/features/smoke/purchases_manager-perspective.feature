...
Feature: Sub-functionality of Purchases feature
  ...
  Scenario: Verify the 'Reporting' button functionality
    When the user clicks on "Reporting" button on the side bar
    Then the page title should be "Purchase Analysis - Odoo"
    And the page URL should contain "purchase.report"